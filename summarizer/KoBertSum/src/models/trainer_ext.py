...
class Trainer(object):
    ...
    def generate(self, test_iter, step, num_sentences=3, cal_lead=False, cal_oracle=False):
        ...
        for batch_idx, batch in enumerate(test_iter):
            ...
            for i, idx in enumerate(selected_ids):
                ...
                if len(_pred) > 0 :
                    _pred = np.array(batch.src_str[i])[selected_ids[i][:min(num_sentences,len(selected_ids[i]))]]
    ...
    def test(self, test_iter, step, cal_lead=False, cal_oracle=False):
        ...
        if ('report_rouge' in vars(self.args)):
